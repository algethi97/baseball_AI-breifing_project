...
[![Release](https://img.shields.io/badge/release-v1.4.0-green.svg)](https://github.com/algethi97/baseball_AI-breifing_project/releases)
...
네이버 스포츠 뉴스를 실시간으로 대량 수집하고 기사 본문(원문 전체)을 정밀 파싱하며, OpenAI 최신 LLM을 결합하여 검색 키워드에 100% 초집중된 심층 브리핑 보고서를 자동 생성합니다. 또한 수집된 기사 원문과 AI 보고서를 관계형 SQLite 데이터베이스로 원클릭 추출하고, 보관된 마크다운 보고서를 인앱에서 즉시 열람할 수 있으며, 기상청 공공데이터를 통해 전국 11개 프로야구 구장의 실시간 기상 관측 데이터 및 **우천 취소 우려 지수**를 직관적인 대시보드로 제공합니다.
